/**
  ...
  ******************************************************************************
  */
#ifndef AI_PCA_CARDIAC_H
#define AI_PCA_CARDIAC_H

#include "pca_cardiac_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_PCA_CARDIAC_MODEL_NAME          "pca_cardiac"
#define AI_PCA_CARDIAC_ORIGIN_MODEL_NAME   "mlp_cardiac_seq"

/******************************************************************************/
#define AI_PCA_CARDIAC_ACTIVATIONS_ALIGNMENT   (4)
#define AI_PCA_CARDIAC_INPUTS_IN_ACTIVATIONS   (4)
#define AI_PCA_CARDIAC_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_PCA_CARDIAC_IN_NUM        (1)

AI_DEPRECATED
#define AI_PCA_CARDIAC_IN \
  ai_pca_cardiac_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_PCA_CARDIAC_IN_SIZE { \
  AI_PCA_CARDIAC_IN_1_SIZE, \
}
#define AI_PCA_CARDIAC_IN_SIZE_BYTES { \
  AI_PCA_CARDIAC_IN_1_SIZE_BYTES, \
}
#define AI_PCA_CARDIAC_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_PCA_CARDIAC_IN_1_CHANNEL     (10)
#define AI_PCA_CARDIAC_IN_1_SIZE        (10)
#define AI_PCA_CARDIAC_IN_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_PCA_CARDIAC_OUT_NUM       (1)

AI_DEPRECATED
#define AI_PCA_CARDIAC_OUT \
  ai_pca_cardiac_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_PCA_CARDIAC_OUT_SIZE { \
  AI_PCA_CARDIAC_OUT_1_SIZE, \
}
#define AI_PCA_CARDIAC_OUT_SIZE_BYTES { \
  AI_PCA_CARDIAC_OUT_1_SIZE_BYTES, \
}
#define AI_PCA_CARDIAC_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_PCA_CARDIAC_OUT_1_CHANNEL     (5)
#define AI_PCA_CARDIAC_OUT_1_SIZE        (5)
#define AI_PCA_CARDIAC_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_PCA_CARDIAC_N_NODES (4)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup pca_cardiac
 ...
 * @ref ai_pca_cardiac_create. Both the activations memory buffer 
 ...
 * using @ref ai_pca_cardiac_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_pca_cardiac_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_pca_cardiac_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_PCA_CARDIAC_*
 * defines into file @ref pca_cardiac.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_pca_cardiac_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_PCA_CARDIAC_H */
