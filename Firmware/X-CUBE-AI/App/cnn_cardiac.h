/**
  ...
  ******************************************************************************
  */
#ifndef AI_CNN_CARDIAC_H
#define AI_CNN_CARDIAC_H

#include "cnn_cardiac_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_CNN_CARDIAC_MODEL_NAME          "cnn_cardiac"
#define AI_CNN_CARDIAC_ORIGIN_MODEL_NAME   "cnn_cardiac"

/******************************************************************************/
#define AI_CNN_CARDIAC_ACTIVATIONS_ALIGNMENT   (4)
#define AI_CNN_CARDIAC_INPUTS_IN_ACTIVATIONS   (4)
#define AI_CNN_CARDIAC_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_CNN_CARDIAC_IN_NUM        (1)

AI_DEPRECATED
#define AI_CNN_CARDIAC_IN \
  ai_cnn_cardiac_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_CNN_CARDIAC_IN_SIZE { \
  AI_CNN_CARDIAC_IN_1_SIZE, \
}
#define AI_CNN_CARDIAC_IN_SIZE_BYTES { \
  AI_CNN_CARDIAC_IN_1_SIZE_BYTES, \
}
#define AI_CNN_CARDIAC_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CNN_CARDIAC_IN_1_HEIGHT      (181)
#define AI_CNN_CARDIAC_IN_1_CHANNEL     (1)
#define AI_CNN_CARDIAC_IN_1_SIZE        (181)
#define AI_CNN_CARDIAC_IN_1_SIZE_BYTES  (724)

/******************************************************************************/
#define AI_CNN_CARDIAC_OUT_NUM       (1)

AI_DEPRECATED
#define AI_CNN_CARDIAC_OUT \
  ai_cnn_cardiac_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_CNN_CARDIAC_OUT_SIZE { \
  AI_CNN_CARDIAC_OUT_1_SIZE, \
}
#define AI_CNN_CARDIAC_OUT_SIZE_BYTES { \
  AI_CNN_CARDIAC_OUT_1_SIZE_BYTES, \
}
#define AI_CNN_CARDIAC_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CNN_CARDIAC_OUT_1_CHANNEL     (5)
#define AI_CNN_CARDIAC_OUT_1_SIZE        (5)
#define AI_CNN_CARDIAC_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_CNN_CARDIAC_N_NODES (10)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup cnn_cardiac
 ...
 * @ref ai_cnn_cardiac_create. Both the activations memory buffer 
 ...
 * using @ref ai_cnn_cardiac_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cnn_cardiac_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cnn_cardiac_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_CNN_CARDIAC_*
 * defines into file @ref cnn_cardiac.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_cnn_cardiac_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_CNN_CARDIAC_H */
